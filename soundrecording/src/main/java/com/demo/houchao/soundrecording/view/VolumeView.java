package com.demo.houchao.soundrecording.view;
...
/**
 * Created by HouChao on 2016/8/4.
 */
...
public class VolumeView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            canvas.drawLine((width / 2) - (mStep * i), mY - 20 * i, (width / 2)
                    + (mStep * i), mY - 20 * i, mPaint);
        }
